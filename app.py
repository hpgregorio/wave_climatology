...
def update_plots(n_clicks,  selected_location, start_year, end_year, selected_month, selected_month_wind, altura1, periodo1, direcao1, altura2, periodo2, direcao2, altura3, periodo3, direcao3, active_tab, selected_hours, selected_hours_others, selected_month_others):
	...
	if active_tab == "waves":
		...
		return [fig1, fig2, rose, fig3, fig_custom_conditions, fig4, fig5, rose, fig6, go.Figure(), go.Figure(), go.Figure(), go.Figure(), go.Figure(), go.Figure(), go.Figure(), go.Figure(), go.Figure(), go.Figure(), go.Figure(),  go.Figure(), active_tab, {'display': 'block'}, {'display': 'none'}, {'display': 'none'}, fig_map,0]
		...
		return [go.Figure(), go.Figure(), go.Figure(), go.Figure(), go.Figure(), go.Figure(), go.Figure(), go.Figure(), go.Figure(), fig1_w, fig2a_w, rose, fig2_w, fig4_w, fig5a_w, rose, fig5_w, go.Figure(), go.Figure(), go.Figure(), go.Figure(), active_tab, {'display': 'none'}, {'display': 'block'}, {'display': 'none'}, fig_map,0]
		...
		return [go.Figure(), go.Figure(), go.Figure(), go.Figure(), go.Figure(), go.Figure(), go.Figure(), go.Figure(), go.Figure(), go.Figure(), go.Figure(), go.Figure(), go.Figure(), go.Figure(),  go.Figure(),  go.Figure(),  go.Figure(), fig_other, fig_other_prec, fig_other_temp, fig_other_sst, active_tab, {'display': 'none'}, {'display': 'none'}, {'display': 'block'}, fig_map,0]
